...
export default function Onboarding() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      try {
        const { data: categoryData, error: categoryError } = await supabase
          .rpc("derive_trader_category", {
            p_holding_time: answers.holding_time || null,
            p_trade_frequency: answers.trade_frequency || null,
            p_risk_per_trade: answers.risk_per_trade || null,
          });
      ...
      // Update profile with answers and category
      ...
      toast({
        ...
        description: categoryName
          ...
          : "Your trading profile has been set up.",
      });
