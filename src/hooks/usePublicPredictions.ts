...
const FAKE_PROFILES: Record<string, { display_name: string; avatar_url: string; bio: string; current_streak: number; total_predictions: number; total_hits: number; streak_type: string }> = {
  ...
  '66666666-6666-6666-6666-666666666666': { display_name: 'SwingKing', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SwingKing', bio: 'Index ETF swing trader. SPY/QQQ specialist.', current_streak: 4, total_predictions: 98, total_hits: 67, streak_type: 'hit' },
  '77777777-7777-7777-7777-777777777777': { display_name: 'ScalpMaster', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ScalpMaster', bio: 'Scalping forex pairs since 2018.', current_streak: 6, total_predictions: 312, total_hits: 198, streak_type: 'hit' },
  '88888888-8888-8888-8888-888888888888': { display_name: 'DiamondHands', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=DiamondHands', bio: 'HODL gang. Long-term crypto investor.', current_streak: 12, total_predictions: 24, total_hits: 21, streak_type: 'hit' },
  '99999999-9999-9999-9999-999999999999': { display_name: 'OptionsWizard', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=OptionsWizard', bio: 'Options strategies. Theta gang member.', current_streak: 3, total_predictions: 145, total_hits: 89, streak_type: 'hit' },
  'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa': { display_name: 'AlgoTrader', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=AlgoTrader', bio: 'Quantitative trading. Python & ML.', current_streak: 8, total_predictions: 456, total_hits: 298, streak_type: 'hit' },
  'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb': { display_name: 'MemeStockMaven', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=MemeStockMaven', bio: 'Riding the meme wave 🚀', current_streak: 1, total_predictions: 78, total_hits: 42, streak_type: 'miss' },
  'cccccccc-cccc-cccc-cccc-cccccccccccc': { display_name: 'OilBaron', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=OilBaron', bio: 'Energy sector specialist.', current_streak: 2, total_predictions: 56, total_hits: 38, streak_type: 'hit' },
  'dddddddd-dddd-dddd-dddd-dddddddddddd': { display_name: 'AsianSession', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=AsianSession', bio: 'Trading Tokyo & Sydney sessions.', current_streak: 5, total_predictions: 134, total_hits: 89, streak_type: 'hit' },
  'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee': { display_name: 'ValueHunter', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ValueHunter', bio: 'Buffett disciple. Deep value investing.', current_streak: 9, total_predictions: 34, total_hits: 28, streak_type: 'hit' },
  'ffffffff-ffff-ffff-ffff-ffffffffffff': { display_name: 'CryptoWhale', avatar_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=CryptoWhale', bio: 'Alt season hunter. Finding the next 100x.', current_streak: 4, total_predictions: 89, total_hits: 52, streak_type: 'hit' },
};
