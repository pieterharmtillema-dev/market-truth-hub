...
// Fake demo profiles for testing/demo purposes - using character configs for hero display
export const FAKE_PROFILES: Record<string, PublicProfile> = {
  '11111111-1111-1111-1111-111111111111': { user_id: '11111111-1111-1111-1111-111111111111', display_name: 'CryptoKing', avatar_url: createSimpleAvatar('#F5D0C5', 'medium', '#D4AF37', 'star', 'smile', 'crown'), bio: 'Full-time crypto trader. BTC maximalist.', current_streak: 7, total_predictions: 156, total_hits: 112, streak_type: 'hit', created_at: '2024-01-15', is_verified: true, trader_category: 'swing_trader' },
  '22222222-2222-2222-2222-222222222222': { user_id: '22222222-2222-2222-2222-222222222222', display_name: 'ForexMaster', avatar_url: createSimpleAvatar('#FFE4D6', 'short', '#3D2314', 'normal', 'smirk', 'glasses'), bio: 'Forex scalper | 5+ years experience', current_streak: 3, total_predictions: 89, total_hits: 58, streak_type: 'hit', created_at: '2024-03-22', is_verified: true, trader_category: 'scalper' },
  '33333333-3333-3333-3333-333333333333': { user_id: '33333333-3333-3333-3333-333333333333', display_name: 'StockWhisperer', avatar_url: createSimpleAvatar('#FFE4D6', 'medium', '#8B4513', 'wink', 'smile', 'sunglasses'), bio: 'Value investor turned swing trader', current_streak: 2, total_predictions: 234, total_hits: 145, streak_type: 'miss', created_at: '2023-11-08', is_verified: false, trader_category: 'swing_trader' },
  '44444444-4444-4444-4444-444444444444': { user_id: '44444444-4444-4444-4444-444444444444', display_name: 'TechTrader', avatar_url: createSimpleAvatar('#F5D0C5', 'short', '#3D2314', 'happy', 'grin', 'cap'), bio: 'Tech stocks enthusiast. NASDAQ focused.', current_streak: 5, total_predictions: 67, total_hits: 41, streak_type: 'hit', created_at: '2024-06-01', is_verified: true, trader_category: 'day_trader' },
  '55555555-5555-5555-5555-555555555555': { user_id: '55555555-5555-5555-5555-555555555555', display_name: 'GoldBull', avatar_url: createSimpleAvatar('#7B5544', 'curly', '#D4AF37', 'normal', 'smile', 'sunglasses'), bio: 'Commodities specialist. Gold & Silver.', current_streak: 1, total_predictions: 42, total_hits: 28, streak_type: 'miss', created_at: '2024-08-14', is_verified: false, trader_category: 'position_trader' },
  '66666666-6666-6666-6666-666666666666': { user_id: '66666666-6666-6666-6666-666666666666', display_name: 'SwingKing', avatar_url: createSimpleAvatar('#9E7653', 'none', '#1A1A1A', 'normal', 'smirk', 'sunglasses'), bio: 'Index ETF swing trader. SPY/QQQ specialist.', current_streak: 4, total_predictions: 98, total_hits: 67, streak_type: 'hit', created_at: '2024-02-10', is_verified: true, trader_category: 'swing_trader' },
  '77777777-7777-7777-7777-777777777777': { user_id: '77777777-7777-7777-7777-777777777777', display_name: 'ScalpMaster', avatar_url: createSimpleAvatar('#D4A574', 'none', '#B7410E', 'normal', 'neutral', 'none'), bio: 'Scalping forex pairs since 2018. Quick in, quick out.', current_streak: 6, total_predictions: 312, total_hits: 198, streak_type: 'hit', created_at: '2023-08-20', is_verified: true, trader_category: 'scalper' },
  '88888888-8888-8888-8888-888888888888': { user_id: '88888888-8888-8888-8888-888888888888', display_name: 'DiamondHands', avatar_url: createSimpleAvatar('#7B5544', 'none', '#1A1A1A', 'star', 'grin', 'headphones'), bio: 'HODL gang. Long-term crypto investor.', current_streak: 12, total_predictions: 24, total_hits: 21, streak_type: 'hit', created_at: '2021-05-15', is_verified: true, trader_category: 'investor' },
  '99999999-9999-9999-9999-999999999999': { user_id: '99999999-9999-9999-9999-999999999999', display_name: 'OptionsWizard', avatar_url: createSimpleAvatar('#FFE4D6', 'medium', '#8B5CF6', 'wink', 'smile', 'sunglasses'), bio: 'Options strategies. Theta gang member.', current_streak: 3, total_predictions: 145, total_hits: 89, streak_type: 'hit', created_at: '2024-01-05', is_verified: false, trader_category: 'day_trader' },
  'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa': { user_id: 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', display_name: 'AlgoTrader', avatar_url: createSimpleAvatar('#E8C4A8', 'short', '#3D2314', 'normal', 'smile', 'sunglasses'), bio: 'Quantitative trading. Python & ML enthusiast.', current_streak: 8, total_predictions: 456, total_hits: 298, streak_type: 'hit', created_at: '2023-03-12', is_verified: true, trader_category: 'scalper' },
  'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb': { user_id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', display_name: 'MemeStockMaven', avatar_url: createSimpleAvatar('#F5D0C5', 'none', '#228B22', 'happy', 'open', 'cap'), bio: 'Riding the meme wave 🚀 GME/AMC veteran', current_streak: 1, total_predictions: 78, total_hits: 42, streak_type: 'miss', created_at: '2024-04-01', is_verified: false, trader_category: 'day_trader' },
  'cccccccc-cccc-cccc-cccc-cccccccccccc': { user_id: 'cccccccc-cccc-cccc-cccc-cccccccccccc', display_name: 'OilBaron', avatar_url: createSimpleAvatar('#D4A574', 'short', '#1A1A1A', 'normal', 'smirk', 'hat'), bio: 'Energy sector specialist. Crude & Natural Gas.', current_streak: 2, total_predictions: 56, total_hits: 38, streak_type: 'hit', created_at: '2023-10-20', is_verified: true, trader_category: 'position_trader' },
  'dddddddd-dddd-dddd-dddd-dddddddddddd': { user_id: 'dddddddd-dddd-dddd-dddd-dddddddddddd', display_name: 'AsianSession', avatar_url: createSimpleAvatar('#E8C4A8', 'short', '#1A1A1A', 'normal', 'smile', 'headphones'), bio: 'Trading Tokyo & Sydney sessions. JPY pairs focused.', current_streak: 5, total_predictions: 134, total_hits: 89, streak_type: 'hit', created_at: '2024-05-18', is_verified: true, trader_category: 'day_trader' },
  'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee': { user_id: 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', display_name: 'ValueHunter', avatar_url: createSimpleAvatar('#C69C6D', 'none', '#1A1A1A', 'normal', 'smile', 'sunglasses'), bio: 'Buffett disciple. Deep value investing.', current_streak: 9, total_predictions: 34, total_hits: 28, streak_type: 'hit', created_at: '2022-11-01', is_verified: false, trader_category: 'investor' },
  'ffffffff-ffff-ffff-ffff-ffffffffffff': { user_id: 'ffffffff-ffff-ffff-ffff-ffffffffffff', display_name: 'CryptoWhale', avatar_url: createSimpleAvatar('#C69C6D', 'medium', '#1A1A1A', 'normal', 'grin', 'sunglasses'), bio: 'Alt season hunter. Finding the next 100x.', current_streak: 4, total_predictions: 89, total_hits: 52, streak_type: 'hit', created_at: '2023-12-01', is_verified: true, trader_category: 'swing_trader' },
};
